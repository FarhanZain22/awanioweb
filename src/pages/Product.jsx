...
const Landing = () => {
  ...
  const translations = {
    ID: {
      ...
      btnStart: "Minta Demo", // Disesuaikan agar senada dengan fungsi
          ...
          <div className="relative w-full h-[360px] sm:h-[480px] lg:h-[635px] bg-cover bg-center">
            ...
            <div className="relative z-10 max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col justify-center">
              <div className="max-w-[650px]">
                ...
                <div className="mt-8">
                  <Link to="/demo">
                    <button className="px-10 py-3 sm:px-16 sm:py-4 text-white text-lg sm:text-xl font-semibold rounded-full bg-[#0A5EA8] shadow-[0_6px_0_#063B6A] transition-all duration-100 ease-out active:translate-y-[4px] active:shadow-none hover:bg-[#0d69ba]">
                      {text.btnStart}
                    </button>
                  </Link>
                </div>
